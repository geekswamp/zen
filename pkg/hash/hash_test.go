...
import (
	...
	"github.com/geekswamp/zen/pkg/hash"
...
func TestHashGenerate(t *testing.T) {
	...
	h := hash.New(pepper, memory, iterations, saltLength, keyLength, parallelism)
...
func TestDifferentPeppers(t *testing.T) {
	...
	h1 := hash.New(pepper1, memory, iterations, saltLength, keyLength, parallelism)
	h2 := hash.New(pepper2, memory, iterations, saltLength, keyLength, parallelism)
