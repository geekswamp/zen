...
// NewErrorCode creates a new ErrorCode instance with the specified error code and detail.
// It panics if the error code is already registered in errCodes to prevent duplicate error codes.
